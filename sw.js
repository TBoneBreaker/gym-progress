...
const ASSETS=["./","./index.html","./manifest.webmanifest","./icon-180.png","./icon-512.png","./patch-v10.js","./patch-v11.js"];
...
async function documentResponse(request){
  ...
  if(!html.includes("patch-v10.js"))html=html.replace("</body>",'<script src="./patch-v10.js?v=12"></script></body>');
  if(!html.includes("patch-v11.js"))html=html.replace("</body>",'<script src="./patch-v11.js?v=12"></script></body>');
